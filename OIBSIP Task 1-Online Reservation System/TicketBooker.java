...
public class TicketBooker {
    ...
    public void cancelTicket(int passengerId) {
        ...
        if (racList.size() > 0) {
            ...
            OnlineReservation.bookTicket(passengerFromRAC);
        }
    }
    public void printAvailable() {
        System.out.println("Available Lower Berths seats" + availableLowerBerths);
        System.out.println("Available Middle Berths seats" + availableMiddleBerths);
        System.out.println("Available Upper Berths seats" + availableUpperBerths);
        System.out.println("Available RACs seats" + availableRacTickets);
