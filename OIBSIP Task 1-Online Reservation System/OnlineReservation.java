// Chilamakuru Sai Venkata Yaswanth
import java.util.*;
public class OnlineReservation {
    public static void bookTicket(Passenger p) {
        ...
        if ((p.berthPreference.equals("L") && TicketBooker.availableLowerBerths > 0) ||
            ...
            if (p.berthPreference.equals("L")) {
                System.out.println("Given Lower Berth");
                ...
                System.out.println("Given Middle Berth");
                ...
                System.out.println("Given Upper Berth");
    ...
    public static void main(String[] args) {
        ...
        while (loop) {
            ...
            switch (choice) {
                case 1: {
                    System.out.println("Enter Passenger Name, Age and Choose Berth preference (L,M or U)");
                    String name = s.next();
                    int age = s.nextInt();
